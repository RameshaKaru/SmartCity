...
package org.wso2.iot.smartCity.api.constants;
...
public class DeviceTypeConstants {
    ...
    public static final String DATA_SOURCE_NAME = "jdbc/WSO2_CITY_ANALYTICS";
    ...
    public static final String PLACE_ROLE = "place-%s";
    public final static String PLACE_GROUP_NAME = "PLACE-%s";
